...
if(position_meeting(mouse_x,mouse_y, self))
{
	if(instance_exists(obj_menuItemLemonadeStand))
	{
		...
		{
			var item = instance_create_depth(x,yy,0,obj_menuItemLemonadeStand);
